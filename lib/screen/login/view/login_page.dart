...
class _LoginPage extends State<LoginPage> {
  ...
  listener: (context, state) async {
    if(state is LoginLoading){
      ...
      await _storageService.writeData(CText.userId, state.loginRespModel.data!.userId ?? '');
      await _storageService.writeData(CText.driverNo, state.loginRespModel.data!.driverNo ?? '');
                  ...
                  children: [
                    ...
                    CustomTextFormField(
                      ...
                      obscureText: onsecure,
                       ...
                       }, icon: Icon(onsecure ? CupertinoIcons.eye_fill : CupertinoIcons.eye_slash_fill)),
                    ),
                    ...
                    MaterialButton(
                      onPressed: () {
                        ...
                        loginBloc.add(LoginButtonPressed(password: passwordController.text, username: usernameController.text));
                      },
                      height: 50,
                      minWidth: 360,
